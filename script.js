function startFarewell() {
    ...
    // Ganti pesan
    message.textContent = "MASA DEPAN BERENCANA";
    subMessage.textContent = "UNTUK WANAYASA, LU ORANGNYA ANJAY BANGET DAH! MAAF YA WAKTU ITU PERNAH NGERIBETIN PERKARA TANDA TANGAN HEHE. Digeboy-geboy mujair Nang-ning-nong, nang-ning-nong Pak gulipak, bang dung ding, ser ";
